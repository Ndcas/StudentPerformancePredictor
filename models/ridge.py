...
MODEL_FILE_NAME = "ridge_regression.pkl"
...
def train():
    ...
    param_grid["regressor__solver"] = ["auto", "svd", "cholesky", "sag"]
    ...
    print("Đang dò tham số và huấn luyện mô hình Ridge Regression...")
    ...
    print(f"Hoàn tất huấn luyện mô hình Ridge Regression trong {datetime.datetime.now() - start}")
